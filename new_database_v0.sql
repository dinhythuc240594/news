...
\restrict J8DvcEKioqTRc0GhPHytVU11xLXG0DppQnsN3A3jrb2ehlvHhtNGf3r2dADzTHk

-- Dumped from database version 17.7
-- Dumped by pg_dump version 17.7

-- Started on 2025-12-22 22:32:15
...
CREATE TABLE public.comments (
    ...
    news_international_id integer,
    CONSTRAINT chk_comments_has_news CHECK (((news_id IS NOT NULL) OR (news_international_id IS NOT NULL)))
);
...
CREATE TABLE public.saved_news (
    ...
    site character varying(10) DEFAULT 'vn'::character varying,
    news_international_id integer,
    CONSTRAINT chk_saved_news_has_news CHECK (((news_id IS NOT NULL) OR (news_international_id IS NOT NULL)))
);
...
CREATE TABLE public.viewed_news (
    ...
    site character varying(10) DEFAULT 'vn'::character varying,
    news_international_id integer,
    CONSTRAINT chk_viewed_news_has_news CHECK (((news_id IS NOT NULL) OR (news_international_id IS NOT NULL)))
);
...
--
-- TOC entry 5137 (class 0 OID 16784)
-- Dependencies: 218
-- Data for Name: categories; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (15, 'Thời Sự', 'thoi-su', NULL, NULL, 1, NULL, true, '2025-12-17 13:24:54.301507', '2025-12-17 13:24:54.301548', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (16, 'Việt Nam', 'viet-nam', NULL, NULL, 1, 15, true, '2025-12-17 13:25:39.194329', '2025-12-17 13:25:39.19439', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (14, 'Đông Nam Bộ', 'dong-nam-bo', NULL, NULL, 1, 11, true, '2025-12-14 15:30:55.971775', '2025-12-14 15:30:55.971802', 3);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (1, 'Công nghệ', 'cong-nghe', 'Tin tức về công nghệ, phần mềm, ứng dụng', 'tech', 1, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.194365', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (2, 'Kinh tế', 'kinh-te', 'Tin tức kinh tế, tài chính, đầu tư', 'economy', 2, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.219305', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (3, 'Thể thao', 'the-thao', 'Tin tức thể thao trong nước và quốc tế', 'sports', 4, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.260879', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (4, 'Giải trí', 'giai-tri', 'Tin tức giải trí, phim ảnh, ca nhạc', 'entertainment', 3, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.248071', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (5, 'Giáo dục', 'giao-duc', 'Tin tức giáo dục, đào tạo', 'education', 6, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.296838', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (6, 'Sức khỏe', 'suc-khoe', 'Tin tức về sức khỏe, y tế', 'health', 5, NULL, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.289043', 1);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (8, 'Máy tính', 'may-tinh', 'Tin tức về máy tính, laptop', 'laptop', 2, 1, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.21062', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (9, 'Bóng đá', 'bong-da', 'Tin tức bóng đá', 'football', 1, 3, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.27049', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (10, 'Bóng rổ', 'bong-ro', 'Tin tức bóng rổ', 'basketball', 2, 3, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:35:03.279911', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (11, 'Trong Nước', 'trong-nuoc', NULL, NULL, 1, 2, true, '2025-12-14 14:43:18.422417', '2025-12-14 15:35:03.228087', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (12, 'Quốc Tế', 'quoc-te', NULL, NULL, 2, 2, true, '2025-12-14 14:43:34.735706', '2025-12-14 15:35:03.238146', 2);
INSERT INTO public.categories (id, name, slug, description, icon, order_display, parent_id, visible, created_at, updated_at, level) VALUES (7, 'Điện thoại', 'dien-thoai', 'Tin tức về điện thoại, smartphone', 'phone', 1, 1, true, '2025-12-13 17:33:36.42487', '2025-12-14 15:52:52.72584', 2);


--
-- TOC entry 5159 (class 0 OID 17061)
-- Dependencies: 240
-- Data for Name: categories_international; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (1, 'Technology', 'technology', NULL, 'phone', 3, NULL, true, 1, '2025-12-16 15:23:14.809934', '2025-12-16 15:52:15.142965');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (2, 'Economy', 'economy', NULL, 'economy', 1, NULL, true, 1, '2025-12-16 15:23:14.840912', '2025-12-16 15:52:15.045952');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (3, 'Sports', 'sports', NULL, 'sports', 2, NULL, true, 1, '2025-12-16 15:23:14.85339', '2025-12-16 15:52:15.130246');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (4, 'Entertainment', 'entertainment', NULL, 'entertainment', 4, NULL, true, 1, '2025-12-16 15:23:14.864696', '2025-12-16 15:52:15.154361');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (5, 'Education', 'education', NULL, 'education', 5, NULL, true, 1, '2025-12-16 15:23:14.874815', '2025-12-16 15:52:15.165878');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (7, 'Asia', 'asia', NULL, NULL, 1, 2, true, 2, '2025-12-16 15:51:13.819136', '2025-12-16 15:52:15.06532');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (8, 'Africa', 'africa', NULL, NULL, 3, 2, true, 2, '2025-12-16 15:51:31.253753', '2025-12-16 15:52:15.117907');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (9, 'Europe', 'europe', NULL, NULL, 2, 2, true, 2, '2025-12-16 15:52:05.902643', '2025-12-16 15:52:15.095688');
INSERT INTO public.categories_international (id, name, slug, description, icon, order_display, parent_id, visible, level, created_at, updated_at) VALUES (6, 'Health', 'health', NULL, 'health', 6, NULL, true, 1, '2025-12-16 15:23:14.887267', '2025-12-19 13:42:14.582694');


--
-- TOC entry 5151 (class 0 OID 16966)
-- Dependencies: 232
-- Data for Name: comments; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (1, 6, 3, 'Chúc mừng đội tuyển Việt Nam', NULL, true, '2025-12-14 03:17:34.150749', '2025-12-14 03:17:34.150762', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (2, 6, 2, 'Thị trường rất biến động, mọi người chú ý', NULL, true, '2025-12-14 03:19:20.732393', '2025-12-14 03:19:20.73242', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (3, 6, 2, 'Mọi người nên cần quan sát thị trường thêm', NULL, true, '2025-12-14 03:22:21.503276', '2025-12-14 03:22:21.503303', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (4, 6, 7, 'Điện thoại đẹp', NULL, true, '2025-12-21 15:17:07.325265', '2025-12-21 15:17:07.325293', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (5, 6, 7, 'Tôi đã mua hôm thứ 3', NULL, true, '2025-12-21 15:17:25.424445', '2025-12-21 15:17:25.42446', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (6, 6, 7, 'aaaa', NULL, true, '2025-12-21 15:46:45.763924', '2025-12-21 15:46:45.76396', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (7, 6, 7, 'bbbb', NULL, true, '2025-12-21 15:58:47.844577', '2025-12-21 15:58:47.844606', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (8, 6, 10, 'Ca sĩ tốt', NULL, true, '2025-12-21 16:01:11.210827', '2025-12-21 16:01:11.210855', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (9, 6, 3, 'Qúa hay', NULL, true, '2025-12-22 13:14:58.149855', '2025-12-22 13:14:58.149888', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (10, 6, 10, 'Good', NULL, true, '2025-12-22 13:35:17.646646', '2025-12-22 13:35:17.646676', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (11, 6, 10, 'Very good', NULL, true, '2025-12-22 13:35:23.846762', '2025-12-22 13:35:23.846791', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (12, 6, 6, 'Good', NULL, true, '2025-12-22 14:09:23.096033', '2025-12-22 14:09:23.096041', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (13, 6, 5, 'Good', NULL, true, '2025-12-22 14:09:34.915264', '2025-12-22 14:09:34.915289', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (14, 6, 9, 'Ok Ok', NULL, true, '2025-12-22 14:39:54.631115', '2025-12-22 14:39:54.631143', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (15, 6, 10, 'Ok', NULL, true, '2025-12-22 14:55:52.578757', '2025-12-22 14:55:52.578778', 'en', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (16, 6, NULL, 'Good news', NULL, true, '2025-12-22 15:13:07.219525', '2025-12-22 15:13:07.219557', 'en', 10);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (17, 6, NULL, 'Happy news', NULL, true, '2025-12-22 15:13:12.058597', '2025-12-22 15:13:12.058626', 'en', 10);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (18, 6, NULL, 'http://localhost:5000/en/news/china-finds-largest-undersea-gold-deposit-in-asia
Good news', NULL, true, '2025-12-22 15:13:57.452321', '2025-12-22 15:13:57.452348', 'en', 9);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (19, 6, NULL, 'Good major', NULL, true, '2025-12-22 15:14:25.87341', '2025-12-22 15:14:25.873429', 'en', 6);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (20, 6, NULL, 'News exactly', NULL, true, '2025-12-22 15:14:36.460302', '2025-12-22 15:14:36.46033', 'en', 6);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (21, 6, 16, 'Quảng cáo đỉnh cao', NULL, true, '2025-12-22 15:14:56.890909', '2025-12-22 15:14:56.89094', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (22, 6, 16, 'Nể thật sự', NULL, true, '2025-12-22 15:15:03.347301', '2025-12-22 15:15:03.34733', 'vn', NULL);
INSERT INTO public.comments (id, user_id, news_id, content, parent_id, is_active, created_at, updated_at, site, news_international_id) VALUES (23, 1, NULL, 'Good', NULL, true, '2025-12-22 15:24:17.814702', '2025-12-22 15:24:17.814731', 'en', 13);


--
-- TOC entry 5155 (class 0 OID 17011)
-- Dependencies: 236
-- Data for Name: menu_items; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (2, 'Kinh tế', 'kinh-te', 'economy', 2, NULL, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (3, 'Thể thao', 'the-thao', 'sports', 3, NULL, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (4, 'Giải trí', 'giai-tri', 'entertainment', 4, NULL, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (5, 'Giáo dục', 'giao-duc', 'education', 5, NULL, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (6, 'Sức khỏe', 'suc-khoe', 'health', 6, NULL, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (7, 'Điện thoại', 'dien-thoai', 'phone', 1, 1, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (8, 'Máy tính', 'may-tinh', 'laptop', 2, 1, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (9, 'Bóng đá', 'bong-da', 'football', 1, 3, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (10, 'Bóng rổ', 'bong-ro', 'basketball', 2, 3, true, NULL, NULL);
INSERT INTO public.menu_items (id, name, slug, icon, order_display, parent_id, visible, created_at, updated_at) VALUES (1, 'Công nghệ', 'cong-nghe', 'tech', 3, NULL, true, NULL, '2025-12-14 06:21:44.328219');
...
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (2, 'Speeding bus flips on Indonesian highway, killing at least 16', 'speeding-bus-flips-on-indonesian-highway-killing-at-least-16', 'A coach bus slammed into a barrier on an Indonesian highway early Monday, flipping over in an accident that killed at least 16 people, a rescue worker said.', '<p>The bus, which was headed from the capital Jakarta to Yogyakarta, was travelling at a "fairly high" speed when it reached a turn at a highway interchange, local search and rescue agency head Budiono said in a statement.</p>
...
<p>To many travelers, Vietnam is first discovered through taste rather than landmarks.</p>', 'https://i1-english.vnecdn.net/2025/12/22/ngodocbanhmi17663838808289-176-3116-5543-1766391548.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=wgm8ukwIM1WAfcA9JajY0w', NULL, 6, 1, 1, 'published', false, false, 1, NULL, NULL, NULL, 'english', NULL, NULL, '2025-12-22 13:12:38.209407', '2025-12-22 12:47:34.003793', '2025-12-22 15:15:54.367761', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (6, 'Why returning home remains tough transition for Vietnamese migrant workers', 'why-returning-home-remains-tough-transition-for-vietnamese-migrant-workers', 'Three years ago, Thanh Truc, a 33-year-old woman from southern Vinh Long province, returned to Vietnam after working in Japan with savings of VND200 million (US$7,600). Today, she is preparing to leave again.', '<p>"I just don’t know what to do at home anymore," she said. "I never expected things to be this difficult."</p>
...
<p>The 13th plenum of the 13th Party Central Committee opened in Hanoi on Monday, with discussions focusing on preparations for the 14th National Party Congress and socio-economic issues.</p>', 'https://i1-english.vnecdn.net/2025/12/22/20251222tw15khaimac811767-1766-3237-2581-1766376891.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=Fms0Dos9fmTnMODK_qgXFA', NULL, 7, 1, 1, 'published', false, false, 2, NULL, NULL, NULL, 'english', NULL, NULL, '2025-12-22 11:15:11', '2025-12-22 12:48:07.582288', '2025-12-22 15:15:39.786423', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (12, 'Tactical analysis: How Vietnam stage classic comeback against Thailand in SEA Games final', 'tactical-analysis-how-vietnam-stage-classic-comeback-against-thailand-in-sea-games-final', 'Coach Kim Sang-sik''s decisive personnel changes, combined with the decision to push the team higher up and apply greater pressure from the front line, were the catalysts for Vietnam''s emotional comeback against Thailand in the 33rd SEA Games men’s football final.', '<img src="https://i1-thethao.vnecdn.net/2025/12/18/17b929c9-8621-4a3f-88a1-4f278a-5489-3024-1766073517.jpg?w=0&h=0&q=100&dpr=1&fit=crop&s=B2fn_6HzmP2QWFQhAuFBAQ" alt="" />
<p>Vietnam entered the match at Rajamangala Stadium with a cautious approach when the team are out of possession, adopting a 5-4-1 defensive structure with striker Nguyen Dinh Bac at the top of the attacking line.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/1-1766073129-8173-1766073517.png?w=0&h=0&q=100&dpr=1&fit=crop&s=uah-PHHDCPftG-a5gMlC-w" alt="" />
<p>By failing to apply pressure from the front line, Coach Kim’s players allowed Thailand to build up play comfortably from the back. Specifically, the home team''s left center-back, Chanon Tamma, a player known for his ball control and ability to break lines with his passes, was left open to distribute the ball.</p>
<p>Vietnam only started pressing when Thailand started delivering the ball to the flanks, which revealed space in the midfield and the host exploited this. Based on their three previous matches, Thailand showed strength in passing and team play on the flanks, with players staying close to the ball for easier connection. That’s why they can easily switch from attacking on the wings to the middle, with players cutting inside without facing much pressure. The second goal by captain Seksan Ratree was typical of Thailand’s playing style in the first half.</p>
<p>Recognizing that the midfield was being overpowered, coach Kim made his first crucial adjustment before halftime. He replaced Nguyen Thai Quoc Cuong with Nguyen Thai Son, a player possessing interception and passing abilities, in an effort to cover the space in front of Vietnam’s defense.</p>
<p>Trailing by two goals at the break, Kim had to make further adjustments in the second half, changing both pressing tactics and personnel. Le Van Thuan and Nguyen Thanh Nhan were brought in to replace Viktor Le and Khuat Van Khang in the attacking line. Both substitutes had previously made their mark by scoring off the bench in the 2-0 semi-final victory against the Philippines.</p>
<p>From this moment, the Vietnam’s formation was pushed higher, shifting from a mid-low block to a mid-high system.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/2-1766073155-4963-1766073517.png?w=0&h=0&q=100&dpr=1&fit=crop&s=fxRTOqxcrPwN0MdtelPYaw" alt="" />
<p>With renewed energy, the team in red transformed their pressing tactics into a potent offensive weapon. While Dinh Bac maintained his position at the top of the attacking line, his movement changed. He often pressed from outside the box, playing like a left-winger who makes sprints into the half-space or cuts inside, targeting the Thailand defense''s build-up play.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/19/3-1766080288-2559-1766080490.png?w=0&h=0&q=100&dpr=1&fit=crop&s=uSkqI4Hz56MHPy9Oh-9aEQ" alt="" />
<p>This pressure forced Thailand goalkeeper Sorawat Phosaman into making long balls up the field. Simultaneously, Vietnam’s defense stepped up to the halfway line, compressing the space between the lines and allowing center-back Nguyen Hieu Minh to intercept loose balls easily.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/19/4-1766080238-2757-1766080490.png?w=0&h=0&q=100&dpr=1&fit=crop&s=eWizfWzOoeEc2-mE_yUrtA" alt="" />
<p>This high-pressing tactic paid off quickly. Thanh Nhan recovered the ball in the opponent''s half to spark an attack. Thai Son then delivered a precision through-ball to Dinh Bac, who made the run and broke free behind the disorganized defense of Thailand. Keeper Phosaman had no choice but to rush out as Dinh Bac was fouled. On the spot, he converted the penalty to reduce the deficit to 1-2.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/5-1766073234-7113-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=0xadcrkSsJ5lC18IZMYdyw" alt="" />
<img src="https://i1-thethao.vnecdn.net/2025/12/18/6-1766073255-9768-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=BbpHhk-6a0nOiVDXPM4U_A" alt="" />
<p>Ten minutes later, another neat ball recovery near the halfway line, made possible by the higher defensive line compared to the first half, started the move for the equalizer. A sharp combination between Van Thuan in the center and Thai Son on the left flank ended with a long-range shot that resulted in a corner.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/7-1766073289-6655-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=omA6cAwBQQviT3DmEwA1gA" alt="" />
<img src="https://i1-thethao.vnecdn.net/2025/12/18/8-1766073289-3360-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=Fp7RxfIjYNOKsPkKMCH1mw" alt="" />
<img src="https://i1-thethao.vnecdn.net/2025/12/18/9-1766073289-1603-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=iLLjAtm_wsmOogdTNoYmTg" alt="" />
<p>From the set-piece, a trademark strength under the South Korean coach, Vietnam leveled the score at 2-2. Van Thuan delivered a curling cross from the corner to the far post, where center-backs Hieu Minh and Pham Ly Duc were positioned to apply pressure, forcing an own goal from Waris Choolthong.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/10-1766073340-2925-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=rfmkNYThzp1rPh8nAc_3Cg" alt="" />
<p>The impact of coach Kim''s substitutions created the winning goal to complete the magnificent 3-2 comeback at Rajamangala Stadium. Following a long ball from goalkeeper Tran Trung Kien, Thanh Nhan went for the aerial duel, allowing Vietnam to win the ball in the midfield.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/11-1766073366-6445-1766073518.png?w=0&h=0&q=100&dpr=1&fit=crop&s=OtO6SQxjyGGNK6fOl34mDg" alt="" />
<img src="https://i1-thethao.vnecdn.net/2025/12/18/12-1766073366-6620-1766073519.png?w=0&h=0&q=100&dpr=1&fit=crop&s=u0aI8VP8bhFGH6zwMK3Glw" alt="" />
<p>Thai Son immediately drove forward and passed it to Dinh Bac, who ran down the flank before returning it to Son, who was presented in the box. He made another pass to Van Thuan, who handled the ball well in tight space before finishing from close range. Phosaman had no choice but to punch it out, and Thanh Nhan was there for the rebound.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/13-1766073412-9029-1766073519.png?w=0&h=0&q=100&dpr=1&fit=crop&s=o-LCTm6r0PD8uiWwk-YxQA" alt="" />
<img src="https://i1-thethao.vnecdn.net/2025/12/18/14-1766073412-8738-1766073519.png?w=0&h=0&q=100&dpr=1&fit=crop&s=MMXd_bFZhjUWhoFXEi6UYw" alt="" />
<p>From a disastrous first half that seemingly closed the game for Vietnam, the players, fueled by determination and the brilliant tactical adjustments of coach Kim Sang-sik in the second half, rekindled their hopes to snatch the SEA Games gold medal from hosts Thailand, marking a glorious end to a successful year of Vietnamese football.</p>
<img src="https://iv1.vnecdn.net/thethao/images/web/2025/12/18/viet-nam-3-2-thai-lan-1766075575.jpg?w=0&h=0&q=100&dpr=1&fit=crop&s=srdHS0pXYz1KtgzXv9j7Gw" alt="Việt Nam 3-2 Thái Lan" />
<img src="https://i1-english.vnecdn.net/2025/12/20/buonchua-1766195773-8107-1766195883.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=mggZ25O8lK8ViT1Z2aKJyg" alt="Former Thailand national players clash over SEA Games final defeat against Vietnam" />
<p>A war of words has erupted among former Thailand national team stars following the U22 team''s 2-3 loss against Vietnam in the 33rd SEA Games men''s football final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/19/kimmu-1766137893-1766137905-7196-1766138207.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=1K9lCqobxt_6cM0rQTu-1g" alt="Thai newspaper praises coach Kim Sang-sik''s tactical awareness in Vietnam''s SEA Games football victory" />
<p>Thai newspaper Siamsport claimed that the difference in tactics and personnel adjustment of Vietnam head coach Kim Sang-sik is one of the five lessons in Thailand''s heartbreaking 2-3 defeat in the SEA Games men''s football final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/19/emoti-1766131960-1766131983-8917-1766132037.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=Cu43fPv8o-Rf3afLAJlZCg" alt="Madam Pang heartbroken after Thailand''s defeat to Vietnam in SEA Games final" />
<p>Football Association of Thailand (FAT) president Madam Pang offered just a single word, “heartbroken,” to the media following the host nation''s loss to Vietnam in the 33rd SEA Games men''s football final.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/18/thanh-nha-n-1766068808.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=OfqPO17MLQOreQM_EVHnTw" alt="The historic comeback of Vietnam against Thailand in SEA Games men''s football final" />
<p>In a match for the ages, Vietnam came back from a two-goal deficit to defeat hosts Thailand 3-2 at the Rajamangala Stadium, securing the 33rd SEA Games men''s football gold medal in dramatic fashion.</p>
<img src="https://i1-english.vnecdn.net/2025/12/18/z7341085449330143b4fb5797b5e61-3422-3156-1766070790.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=dj46xL8z3vhRifUqPEajPg" alt="Vietnam rally past Thailand 3-2 after extra time to win SEA Games men’s football gold" />
<p>Vietnam staged a dramatic comeback to defeat host Thailand 3-2 after extra time in the men’s football final at the 33rd SEA Games, securing their fourth gold medal in the competition.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/lifter-1766197296-7899-1766197704.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=R52iCPTTQ7RSr_GaQ0z8aw" alt="Vietnam men’s football team showered with bonuses after winning SEA Games gold medal" />
<p>The Vietnam men''s football team have been rewarded with big bonuses from the Vietnam Football Federation (VFF), sponsors and individuals following their stunning comeback victory over Thailand to secure gold at the 33rd SEA Games.</p>', 'https://i1-thethao.vnecdn.net/2025/12/20/tactica-1766216558-1766216623-5176-1766217200.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=j1UUlu7aMChCGmuToc3yjQ', NULL, 3, 1, 1, 'published', false, false, 0, NULL, NULL, NULL, 'english', NULL, NULL, '2025-12-20 15:13:13', '2025-12-22 15:16:56.925793', '2025-12-22 15:16:56.925822', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (14, 'Thailand sparks controversy by not including Vietnam''s men football gold medal win in SEA Games highlights', 'thailand-sparks-controversy-by-not-including-vietnams-men-football-gold-medal-win-in-sea-games-highlights', 'Host nation Thailand has sparked controversy by leaving out Vietnam''s men''s football victory from the official highlight reel at the 33rd SEA Games closing ceremony.', '<p>Despite being one of the major events, the 3-2 comeback win by Vietnam over the hosts was absent from the 2-minute-and-30-second video shown at the ceremony on Saturday night.</p>
<p>In the recap designed to capture the memorable moments of the 33rd Games, organizers selected questionable clips to represent men''s football. It featured a group stage match between Malaysia and Laos, and a celebration by Vietnam’s Pham Ly Duc following a goal by Nguyen Dinh Bac, also during a group stage encounter against Laos.</p>
<img src="https://i1-english.vnecdn.net/2025/12/22/sigeme-1766378119-8169-1766378376.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=mUtyvHBlupAaRE3wZMsA_g" alt="Vietnam players celebrate the gold medal win after SEA Games the mens football against Thailand on Dec. 18, 2025. Photo by VnExpress/Duc Dong" />
<p>The women''s football segment followed a similar pattern, showing the Philippines celebrating a late group stage goal against Vietnam, rather than moments from the final, where the Philippines triumphed on penalties following a controversial refereeing decision.</p>
<p>Notably, the video focused heavily on Thailand athletes across other sports but completely excluded the host nation''s football and futsal teams, because of their historic failure to secure a single gold medal in any of the four football-related events.</p>
<p>However, Thailand did not shy away from all defeats, as the video included scenes of the Thailand women''s futsal team losing their semi-final penalty shootout against Indonesia, making the exclusion of the men''s football final even more questionable.</p>
<p>This left many fans confused, with social media posts noting the omission attracting hundreds of comments.</p>
<p>The men''s football final match ended in a dramatic fashion. Thailand led 2-0 before Vietnam equalized in just 11 minutes of the second half and eventually won 3-2 in extra time with Nguyen Thanh Nhan''s goal. The result handed Thailand their first home defeat in SEA Games men''s football in 66 years.</p>
<p>While the men’s football final was left out, other Vietnamese athletes did make the cut. The video featured shooters Trinh Thu Vinh and Pham Quang Huy, as well as an esports gamer pointed proudly to the national flag on the jersey after winning. The segment for each sport appeared to be selected based on emotion rather than strictly focusing on gold medal moments or finals.</p>
<p>The closing ceremony on Saturday lasted about 90 minutes. It marked the end of 11 days of competition, where Thailand dominated the medal tally with a record 233 golds. Vietnam finished third with 87 golds, trailing Indonesia''s 91. Malaysia will host the 34th SEA Games in September 2027.</p>
<img src="https://iv1.vnecdn.net/thethao/images/web/2025/12/20/ky-sea-games-nhieu-tranh-cai-khep-lai-1766238261.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=JHG98CyTZ_oSykQ1gGqflg" alt="Kỳ SEA Games nhiều tranh cãi khép lại" />
<img src="https://i1-english.vnecdn.net/2025/12/20/failu-1766229828-1896-1766229977.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=EA3vWUZwpWqmJq7erTkyMg" alt="Thailand loses all football gold medals at SEA Games for first time in history" />
<p>In a devastating defeat on home soil, Thailand has failed to win a single football gold medal at the 33rd SEA Games after losing 1-6 to Indonesia in the men''s futsal final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/vanduo-1766228040-1766228056-7610-1766228404.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=hnnxkQsCoXv8ulsgqTSSzA" alt="Vietnam boxer frustrated with defeat after controversy in SEA Games final against Thailand" />
<p>Vietnamese boxer Nguyen Van Duong has voiced frustration regarding his loss in the men''s under-57 kg boxing final at the 33rd SEA Games, claiming that the Thai opponent’s foul cost him the match.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/20/tactica-1766216558-1766216623-5176-1766217200.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=jAIfNsFx0PUZlW039-fxqA" alt="Tactical analysis: How Vietnam stage classic comeback against Thailand in SEA Games final" />
<p>Coach Kim Sang-sik''s decisive personnel changes, combined with the decision to push the team higher up and apply greater pressure from the front line, were the catalysts for Vietnam''s emotional comeback against Thailand in the 33rd SEA Games men’s football final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/buonchua-1766195773-8107-1766195883.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=mggZ25O8lK8ViT1Z2aKJyg" alt="Former Thailand national players clash over SEA Games final defeat against Vietnam" />
<p>A war of words has erupted among former Thailand national team stars following the U22 team''s 2-3 loss against Vietnam in the 33rd SEA Games men''s football final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/599945115885286467346923133872-1647-8344-1766199270.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=8VuUBX-eyeMDTZDtKa1gNQ" alt="Can Thailand esports star face criminal charges for cheating at SEA Games?" />
<p>The lifetime ban handed to Thailand esports athlete Naraphat "Tokyogurl" Warasin after the 33rd SEA Games has ignited a legal debate about whether cheating in an international sporting event is considered criminal conduct.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/lifter-1766197296-7899-1766197704.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=R52iCPTTQ7RSr_GaQ0z8aw" alt="Vietnam men’s football team showered with bonuses after winning SEA Games gold medal" />
<p>The Vietnam men''s football team have been rewarded with big bonuses from the Vietnam Football Federation (VFF), sponsors and individuals following their stunning comeback victory over Thailand to secure gold at the 33rd SEA Games.</p>', 'https://i1-english.vnecdn.net/2025/12/22/sigeme-1766378061-1766378076-7880-1766378376.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=thdGP8FzBrckdAL7Su1-Kg', NULL, 3, 1, NULL, 'draft', false, false, 0, NULL, NULL, NULL, 'english', NULL, NULL, NULL, '2025-12-22 15:17:16.206863', '2025-12-22 15:17:16.206892', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (15, 'Controversial SEA Games conclude in Thailand as Malaysia named next host', 'controversial-sea-games-conclude-in-thailand-as-malaysia-named-next-host', 'The 33rd SEA Games came to a close in Bangkok on Saturday night, with Vietnam finishing third overall as Thailand dominated the medal table and handed hosting duties to Malaysia.', '<img src="https://i1-english.vnecdn.net/2025/12/20/be-ma-c-2-jpeg-1766237510-1766-2761-6983-1766238815.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=kvzzPKBx1e-RPRFzLl0s-Q" alt="Fireworks explode at the end of the 33rd SEA Games closing ceremony in Thailand, Dec. 20, 2025. Photo by Bui Luong" />
<p>The closing ceremony, which began at 7:30 p.m. on Dec. 20, featured cultural performances, a parade of national delegations and the formal transfer of the SEA Games flag from Thailand to Malaysia.</p>
<p>Malaysia is set to host the 34th SEA Games in September 2027. The program will largely mirror that of the 33rd edition, but several sports, including wrestling, rowing, and canoeing, will be excluded.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/malaysia-jpeg-1766237371-17662-7547-3816-1766238815.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=0u1lQZvQy9ur7IEiQJfw_A" alt="A performance by Malaysia, the next SEA Games host, at the 33rd editions closing ceremony in Thailand, Dec. 20, 2025. Photo by Bui Luong" />
<p>Thai Deputy Prime Minister Thamanat Prompow delivered a speech at the ceremony but mistakenly referred to it as the "opening ceremony" while declaring the event closed, prompting lighthearted banter among Thai social media users.</p>
<p>After 11 days of official competition, the 33rd SEA Games concluded with the host nation finishing atop the medal table with a record-breaking 233 gold among their 499 medals. The event, however, was also marked by a series of controversies, ranging from the opening ceremony to referee issues during competition events.</p>
<p>Indonesia placed second with 333 medals including 91 gold.</p>
<p>Vietnam wrapped up SEA Games with a total of 278 medals, including 87 golds, finishing third overall.</p>
<p>Malaysia ranked fourth with 57 gold medals, followed by Singapore with 52 and the Philippines with 50. Myanmar, Laos, Brunei and Timor-Leste finished at the bottom of the standings, with none of the four delegations winning a gold medal.</p>
<p>In football events, Vietnam led the competition with two gold medals and one silver. Indonesia followed with one gold and one silver, while the Philippines claimed one gold and one bronze. Thailand placed fourth with two silvers and two bronzes, despite being the only team to win medals across all four football categories.</p>
<img src="https://iv1.vnecdn.net/thethao/images/web/2025/12/20/ky-sea-games-nhieu-tranh-cai-khep-lai-1766238261.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=JHG98CyTZ_oSykQ1gGqflg" alt="Kỳ SEA Games nhiều tranh cãi khép lại" />
<img src="https://i1-english.vnecdn.net/2025/12/20/dong3023jpg1766221332809017662-2104-1490-1766228499.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=SeogdeLd7hQlzeglOqyiIA" alt="Thailand breaks SEA Games record with 233 gold medals" />
<p>The final medal standings at the SEA Games 33 were confirmed on Dec. 20, with host nation Thailand smashing the Games record after winning 233 gold medals, while Vietnam finished third overall with 278 medals.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/failu-1766229828-1896-1766229977.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=EA3vWUZwpWqmJq7erTkyMg" alt="Thailand loses all football gold medals at SEA Games for first time in history" />
<p>In a devastating defeat on home soil, Thailand has failed to win a single football gold medal at the 33rd SEA Games after losing 1-6 to Indonesia in the men''s futsal final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/vanduo-1766228040-1766228056-7610-1766228404.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=hnnxkQsCoXv8ulsgqTSSzA" alt="Vietnam boxer frustrated with defeat after controversy in SEA Games final against Thailand" />
<p>Vietnamese boxer Nguyen Van Duong has voiced frustration regarding his loss in the men''s under-57 kg boxing final at the 33rd SEA Games, claiming that the Thai opponent’s foul cost him the match.</p>', 'https://i1-english.vnecdn.net/2025/12/20/be-ma-c-2-jpeg-1766237510-1766-9297-2436-1766238815.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=4G8PWTslpgLOSN5flgnPnw', NULL, 3, 1, NULL, 'draft', false, false, 0, NULL, NULL, NULL, 'english', NULL, NULL, NULL, '2025-12-22 15:17:25.267678', '2025-12-22 15:17:25.267707', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (11, 'Thailand expects SEA Games revenue to exceed forecasts by 2.5 times', 'thailand-expects-sea-games-revenue-to-exceed-forecasts-by-25-times', 'Governor of the Sports Authority of Thailand (SAT), Gongsak Yodmani, projects that the 33rd SEA Games will generate a record-breaking 14 billion baht (US$447.7 million), a figure that far surpasses initial expectations.', '<p>Speaking to Siam Sport, Gongsak confirmed that the Games have already generated over 12 billion baht in value. He expressed confidence that the final tally would reach 14 billion baht, marking the highest economic return for any major sporting event hosted by the country.</p>
<p>This figure is generated from 50 sports and the participation of over 12,000 athletes and officials. The event attracted nearly 400,000 spectators, including athletes'' families, international fans and tourists. In addition, the Games created between 12,000 and 14,000 jobs across the construction, service, transportation and sports sectors.</p>
<img src="https://i1-english.vnecdn.net/2025/12/22/lapday-1766381067-4358-1766381106.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=RE_HPCFQ6oql7_Gu9brmrg" alt="Approximately 10,000 spectators filled the Huamark Arena in Bangkok during Thailands 3-2 victory over Vietnam in the womens volleyball final of the 33rd SEA Games on Dec. 15, 2025. Photo by TVA" />
<p>The revenue number exceeds the expectations of the Ministry of Tourism and Sports (MOTS) by 2.5 times. It is more than six times the event''s operating budget of 2.055 billion baht ($63.5 million), which was approved by the cabinet in June for both the SEA Games and the upcoming Para Games.</p>
<p>The $63.5 million budget of Thailand is roughly half of the $131 million spent by Cambodia for the 2023 Games. This difference is largely due to Thailand''s strategy of utilizing existing facilities, whereas Cambodia invested heavily in new infrastructure. Vietnam spent approximately $44 million hosting the 31st SEA Games, but did not organize the Para Games. Neither Vietnam nor Cambodia disclosed specific revenue from the Games.</p>
<p>This is still not the largest budget Thailand has allocated to a major sporting event. The 1998 Asian Games had a budget of 2.372 billion baht, followed by the 2007 University Games (1.843 billion baht), the 2007 SEA Games and the 2008 Para Games (1.463 billion baht).</p>
<p>Despite the financial success, the 33rd SEA Games were remembered for controversies. The event faced organizational delays stemming from changes in the Thai government, while escalating border tensions led Cambodia to withdraw all athletes immediately after the opening ceremony.</p>
<p>Additionally, severe flooding prevented Songkhla Province from hosting events as planned. The organizing committee also faced backlash over protocol errors involving flags and maps, as well as widespread criticism regarding officiating standards and alleged bias.</p>
<p>The 33rd SEA Games officially concluded on Dec. 20. After 10 days of competition, Thailand topped the medal table with a haul of 233 gold medals, breaking the previous record of 205 set by Vietnam at home in 2022. The hosts also secured 154 silver and 112 bronze medals.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/failu-1766229828-1896-1766229977.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=EA3vWUZwpWqmJq7erTkyMg" alt="Thailand loses all football gold medals at SEA Games for first time in history" />
<p>In a devastating defeat on home soil, Thailand has failed to win a single football gold medal at the 33rd SEA Games after losing 1-6 to Indonesia in the men''s futsal final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/be-ma-c-2-jpeg-1766237510-1766-9297-2436-1766238815.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=-NEgkQDDQAk6T_3UZWIW1Q" alt="Controversial SEA Games conclude in Thailand as Malaysia named next host" />
<p>The 33rd SEA Games came to a close in Bangkok on Saturday night, with Vietnam finishing third overall as Thailand dominated the medal table and handed hosting duties to Malaysia.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/dong3023jpg1766221332809017662-2104-1490-1766228499.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=SeogdeLd7hQlzeglOqyiIA" alt="Thailand breaks SEA Games record with 233 gold medals" />
<p>The final medal standings at the SEA Games 33 were confirmed on Dec. 20, with host nation Thailand smashing the Games record after winning 233 gold medals, while Vietnam finished third overall with 278 medals.</p>', 'https://i1-english.vnecdn.net/2025/12/22/lapday-1766381022-1766381037-9476-1766381106.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=O81KwibU1v5nL3xxihXBCg', NULL, 3, 1, 1, 'published', false, false, 0, NULL, NULL, NULL, 'english', NULL, NULL, '2025-12-22 15:17:51.878156', '2025-12-22 15:16:47.5304', '2025-12-22 15:17:51.882348', true, false, NULL);
INSERT INTO public.news_international (id, title, slug, summary, content, thumbnail, images, category_id, created_by, approved_by, status, is_featured, is_hot, view_count, meta_title, meta_description, meta_keywords, language, source, source_url, published_at, created_at, updated_at, is_api, is_deleted, tags_string) VALUES (13, 'Thailand loses all football gold medals at SEA Games for first time in history', 'thailand-loses-all-football-gold-medals-at-sea-games-for-first-time-in-history', 'In a devastating defeat on home soil, Thailand has failed to win a single football gold medal at the 33rd SEA Games after losing 1-6 to Indonesia in the men''s futsal final.', '<p>The crushing defeat at the Nonthaburi Arena on Friday night marks the first time in history that Thailand has participated in a SEA Games featuring all four football events without securing at least one gold medal.</p>
<p>The men''s futsal tournament, played in a round-robin format, seemed destined for Thailand’s victory. Entering the final match, the hosts sat atop the table with a perfect nine points and a +10 goal difference, having defeated Malaysia, Myanmar and Vietnam. Indonesia, sitting second with 6 points after a loss to Vietnam, needed a miracle, a victory by a margin of more than three goals, to snatch the gold.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/thuasm-1766229878-6669-1766229977.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=vuUsZ_0LBmCPq0FWuZxHkg" alt="A Thailand player shows his disappointment after losing 1-6 to Indonesia in the mens futsal final at the 33rd SEA Games at Nonthaburi Arena, Thailand on Dec. 19, 2025. Photo by Changsuek" />
<p>That miracle unfolded in spectacular fashion. Indonesia dominated from the opening whistle, netting two goals in the first half and adding a third early in the second. Desperate to salvage their goal difference, Thailand resorted to a risky power-play strategy, leaving their goal unguarded. The gamble backfired, as Indonesia punished them with three long-range strikes into an empty net.</p>
<p>The final score of 1-6 handed the gold medal to Indonesia on goal difference, ending Thailand''s perfect record in SEA Games men''s futsal. Prior to this match, Thailand had swept all 10 gold medals in the history of the event.</p>
<p>The result completes a nightmare campaign for the Football Association of Thailand (FAT), which previously targeted a clean sweep of all four gold medals: men''s and women''s football, and men''s and women''s futsal.</p>
<p>In men''s football, Thailand squandered a 2-0 lead in the final against Vietnam to lose 2-3 in extra time, marking their third consecutive SEA Games final defeat. In women''s football, the hosts lost 2-4 on penalties to the Philippines in the semi-finals, settling for bronze. Similarly, the women''s futsal team suffered a shock upset against Indonesia in the semi-finals, drawing 4-4 before losing 6-7 in a penalty shootout.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/failu-1766229897-7903-1766229977.jpg?w=680&h=0&q=100&dpr=1&fit=crop&s=pAs-8LMCWa6yLvl6BSwSOw" alt="Thailand players collapsed after their 2-3 defeat to Vietnam in the SEA Games mens football final at Rajamangala Stadium in Bangkok, on Dec. 18, 2025. Photo by VnExpress/Duc Dong" />
<p>While Thailand fell flat, Vietnam enjoyed a successful campaign, securing gold in men''s football and women''s futsal, along with a silver in women''s football. The Philippines also made history, breaking the long-standing reign of Thailand and Vietnam to win their first-ever gold medal in women''s football.</p>
<p>For Thailand, a nation that has historically dominated the region, winning 16 of 34 men''s football golds and 5 of 14 women''s football, the 33rd SEA Games marked a failure. The men''s football team have not tasted gold since 2017, and the women''s team have been waiting since 2013.</p>
<img src="https://i1-thethao.vnecdn.net/2025/12/20/tactica-1766216558-1766216623-5176-1766217200.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=jAIfNsFx0PUZlW039-fxqA" alt="Tactical analysis: How Vietnam stage classic comeback against Thailand in SEA Games final" />
<p>Coach Kim Sang-sik''s decisive personnel changes, combined with the decision to push the team higher up and apply greater pressure from the front line, were the catalysts for Vietnam''s emotional comeback against Thailand in the 33rd SEA Games men’s football final.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/vanduo-1766228040-1766228056-7610-1766228404.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=hnnxkQsCoXv8ulsgqTSSzA" alt="Vietnam boxer frustrated with defeat after controversy in SEA Games final against Thailand" />
<p>Vietnamese boxer Nguyen Van Duong has voiced frustration regarding his loss in the men''s under-57 kg boxing final at the 33rd SEA Games, claiming that the Thai opponent’s foul cost him the match.</p>
...
<p>The lifetime ban handed to Thailand esports athlete Naraphat "Tokyogurl" Warasin after the 33rd SEA Games has ignited a legal debate about whether cheating in an international sporting event is considered criminal conduct.</p>
<img src="https://i1-english.vnecdn.net/2025/12/20/lifter-1766197296-7899-1766197704.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=R52iCPTTQ7RSr_GaQ0z8aw" alt="Vietnam men’s football team showered with bonuses after winning SEA Games gold medal" />
<p>The Vietnam men''s football team have been rewarded with big bonuses from the Vietnam Football Federation (VFF), sponsors and individuals following their stunning comeback victory over Thailand to secure gold at the 33rd SEA Games.</p>
<img src="https://i1-english.vnecdn.net/2025/12/19/emoti-1766131960-1766131983-8917-1766132037.jpg?w=180&h=108&q=100&dpr=1&fit=crop&s=Cu43fPv8o-Rf3afLAJlZCg" alt="Madam Pang heartbroken after Thailand''s defeat to Vietnam in SEA Games final" />
<p>Football Association of Thailand (FAT) president Madam Pang offered just a single word, “heartbroken,” to the media following the host nation''s loss to Vietnam in the 33rd SEA Games men''s football final.</p>', 'https://i1-english.vnecdn.net/2025/12/20/failu-1766229828-1896-1766229977.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=0pQJT2vv--9qDbS2SCdntA', NULL, 3, 1, 1, 'published', false, false, 3, NULL, NULL, NULL, 'english', NULL, NULL, '2025-12-20 19:24:10', '2025-12-22 15:17:06.881342', '2025-12-22 15:24:03.354675', true, false, NULL);


--
-- TOC entry 5145 (class 0 OID 16867)
-- Dependencies: 226
-- Data for Name: news_tags; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (1, 1, 1);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (2, 1, 3);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (3, 2, 6);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (4, 2, 7);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (5, 3, 8);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (6, 4, 10);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (7, 5, 12);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (8, 6, 13);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (9, 6, 14);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (10, 7, 2);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (11, 7, 3);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (12, 8, 3);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (13, 9, 9);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (14, 10, 11);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (30, 14, 6);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (42, 15, 26);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (43, 15, 27);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (46, 16, 28);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (47, 16, 29);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (50, 17, 28);
INSERT INTO public.news_tags (id, news_id, tag_id) VALUES (51, 17, 29);


--
-- TOC entry 5161 (class 0 OID 17098)
-- Dependencies: 242
-- Data for Name: newsletter_subscriptions; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.newsletter_subscriptions (id, email, is_active, unsubscribe_token, subscribed_at, unsubscribed_at, user_id) VALUES (1, 'dinhythuc10a9@gmail.com', true, 'XioiiYfWgdDjMQc_O9eFoUAohAGOxfEmbdr3tPR9efk', '2025-12-21 11:18:10.877635', NULL, NULL);
INSERT INTO public.newsletter_subscriptions (id, email, is_active, unsubscribe_token, subscribed_at, unsubscribed_at, user_id) VALUES (2, 'dinhythuc240594@gmail.com', false, 'vPAvqcYtdMeqFy19tQmmxJPqMwBapY_Cx9B3gnvRZE0', '2025-12-21 11:26:40.815617', '2025-12-21 11:40:46.41787', NULL);


--
-- TOC entry 5163 (class 0 OID 17119)
-- Dependencies: 244
-- Data for Name: password_reset_tokens; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.password_reset_tokens (id, user_id, token, expires_at, used, created_at) VALUES (1, 6, '0IvSnScc_PfyTZiyr0T-78A7lpydvkznCPZv5T4j7iA', '2025-12-21 12:28:07.278555', true, '2025-12-21 11:28:07.3207');


--
-- TOC entry 5147 (class 0 OID 16932)
-- Dependencies: 228
-- Data for Name: saved_news; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (2, 6, 2, '2025-12-14 03:19:03.367244', 'vn', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (3, 6, 7, '2025-12-21 15:17:10.626047', 'vn', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (4, 6, 3, '2025-12-22 13:14:48.464802', 'vn', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (15, 6, 6, '2025-12-22 14:09:16.542087', 'en', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (16, 6, 5, '2025-12-22 14:09:37.523208', 'en', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (17, 6, 9, '2025-12-22 14:39:47.324861', 'en', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (18, 6, 10, '2025-12-22 14:55:46.590475', 'en', NULL);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (19, 6, NULL, '2025-12-22 15:12:59.698988', 'en', 10);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (20, 6, NULL, '2025-12-22 15:13:43.065753', 'en', 9);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (21, 6, NULL, '2025-12-22 15:14:19.446373', 'en', 6);
INSERT INTO public.saved_news (id, user_id, news_id, created_at, site, news_international_id) VALUES (23, 1, NULL, '2025-12-22 15:24:11.377277', 'en', 13);


--
-- TOC entry 5165 (class 0 OID 17138)
-- Dependencies: 246
-- Data for Name: settings; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (1, 'api_token', 'ltOCs9nyjcEBSou1fQqxcaHAM0v7qUuj', NULL, 'api', '2025-12-21 13:58:08.996542', '2025-12-21 13:58:39.73591');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (2, 'api_base_url', 'https://news-api.techreview.pro', NULL, 'api', '2025-12-21 13:58:08.99658', '2025-12-21 13:58:39.744676');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (3, 'smtp_server', 'smtp.gmail.com', NULL, 'smtp', '2025-12-21 13:58:08.996596', '2025-12-21 13:58:39.74845');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (4, 'smtp_port', '587', NULL, 'smtp', '2025-12-21 13:58:08.996611', '2025-12-21 13:58:39.750944');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (5, 'smtp_username', 'dinhythuc10a9@gmail.com', NULL, 'smtp', '2025-12-21 13:58:08.996625', '2025-12-21 13:58:39.754234');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (6, 'smtp_password', 'nqso ngid ijmz dtap', NULL, 'smtp', '2025-12-21 13:58:08.99664', '2025-12-21 13:58:39.759858');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (7, 'smtp_from_email', 'dinhythuc10a9@gmail.com', NULL, 'smtp', '2025-12-21 13:58:08.996652', '2025-12-21 13:58:39.765242');
INSERT INTO public.settings (id, key, value, description, category, created_at, updated_at) VALUES (8, 'smtp_use_tls', 'true', NULL, 'smtp', '2025-12-21 13:58:08.996664', '2025-12-21 13:58:39.768128');


--
-- TOC entry 5143 (class 0 OID 16855)
-- Dependencies: 224
-- Data for Name: tags; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.tags (id, name, slug, created_at) VALUES (1, 'iPhone', 'iphone', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (2, 'Android', 'android', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (3, 'AI', 'ai', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (4, 'Blockchain', 'blockchain', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (5, 'Startup', 'startup', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (6, 'Chứng khoán', 'chung-khoan', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (7, 'Bất động sản', 'bat-dong-san', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (8, 'World Cup', 'world-cup', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (9, 'Premier League', 'premier-league', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (10, 'Phim Việt Nam', 'phim-viet-nam', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (11, 'Nhạc Việt', 'nhac-viet', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (12, 'Đại học', 'dai-hoc', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (13, 'Y tế', 'y-te', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (14, 'Dinh dưỡng', 'dinh-duong', '2025-12-13 17:33:36.42487');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (25, 'Trong nước', 'trong-nuoc', '2025-12-18 15:07:59.164244');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (26, 'Trong', 'trong', '2025-12-18 15:16:00.226076');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (27, 'nước', 'nuoc', '2025-12-18 15:16:00.261926');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (28, 'Công', 'cong', '2025-12-18 15:33:26.153408');
INSERT INTO public.tags (id, name, slug, created_at) VALUES (29, 'nghệ', 'nghe', '2025-12-18 15:33:26.185693');


--
-- TOC entry 5139 (class 0 OID 16806)
-- Dependencies: 220
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (3, 'editor2', 'editor2@news.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyY5Y5Y5Y5Y5', 'Biên tập viên 2', 'editor', true, '2025-12-13 17:33:36.42487', '2025-12-13 17:33:36.42487', NULL, NULL);
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (4, 'user1', 'user1@news.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyY5Y5Y5Y5Y5', 'Người dùng 1', 'user', true, '2025-12-13 17:33:36.42487', '2025-12-13 17:33:36.42487', NULL, NULL);
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (5, 'user2', 'user2@news.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewY5GyY5Y5Y5Y5Y5', 'Người dùng 2', 'user', true, '2025-12-13 17:33:36.42487', '2025-12-13 17:33:36.42487', NULL, NULL);
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (1, 'admin', 'admin@news.com', 'scrypt:32768:8:1$1LWacKEBH7fGhhYY$8f3f1aa0bb1c1877df77e440d2b42925e7a31fcc22f8234dcf320357808d5011a687e23ae703644fe9de7ec6a0536f42bc4cf5f13c4ca1e40cef8b1592e7f572', 'Quản trị viên', 'admin', true, '2025-12-13 17:33:36.42487', '2025-12-13 17:33:36.42487', NULL, NULL);
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (2, 'editor', 'editor1@news.com', 'scrypt:32768:8:1$EzGmAJdq91vkgsKh$67f5e268660f7c68b5b2e120a7d6abfee1d1444ce3eca86e04a2c3f692a986c4817c7a78a6e750d45a236950065d724a84d0b21ceea753e7dbed51f4b486d98f', 'Biên tập viên 1', 'editor', true, '2025-12-13 17:33:36.42487', '2025-12-13 17:33:36.42487', NULL, NULL);
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (6, 'dinhythuc240594', 'dinhythuc240594@gmail.com', 'scrypt:32768:8:1$aQYT7OmCoyojUgLR$4e5c53f8c5a41947fe337c6f4c39ce81f8a164f0c26c3ed8627d6b8f412f197590be3c2ae8c0ccdd7b790977623c35544c18021ef25c0fe0ac2b115c9d9e2c34', 'Đinh Thức', 'user', true, '2025-12-13 15:59:17.151124', '2025-12-21 11:28:50.20545', '0982109103', 'static/uploads/avatars/avatar_6_avatar-de-thuong-33.jpg');
INSERT INTO public.users (id, username, email, password_hash, full_name, role, is_active, created_at, updated_at, phone, avatar) VALUES (7, 'thuc', 'dinhythuc10a9@gmail.com', 'scrypt:32768:8:1$nBVWRmfxZYRrMq8w$063e58c4631eb5d23925bd208655081e6b0c15ef70a6caa5ef4a0c42b5437d2d95fa6747c9d596a652f2af7c1490a62eebf77ba62c9867e1ca177104909ff78c', 'Thức Đinh', 'editor', true, '2025-12-21 13:28:23.622177', '2025-12-21 13:28:23.622212', '0982109103', NULL);


--
-- TOC entry 5149 (class 0 OID 16949)
-- Dependencies: 230
-- Data for Name: viewed_news; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (2, 6, 2, '2025-12-14 03:19:01.519166', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (3, 2, 15, '2025-12-18 15:20:54.874942', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (4, 2, 3, '2025-12-18 15:21:30.103862', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (6, 6, 7, '2025-12-21 15:58:34.999048', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (5, 1, 3, '2025-12-22 12:59:03.7815', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (8, 1, 10, '2025-12-22 13:11:57.78855', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (1, 6, 3, '2025-12-22 13:14:45.272905', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (10, 6, 5, '2025-12-22 14:09:26.939931', 'en', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (11, 6, 9, '2025-12-22 14:39:41.513641', 'en', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (9, 6, 6, '2025-12-22 14:55:21.567188', 'en', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (7, 6, 10, '2025-12-22 14:55:34.443629', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (12, 6, 13, '2025-12-22 14:55:57.495402', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (13, 6, NULL, '2025-12-22 15:12:54.350868', 'en', 10);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (14, 6, NULL, '2025-12-22 15:13:37.377013', 'en', 9);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (15, 6, NULL, '2025-12-22 15:14:14.297041', 'en', 6);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (16, 6, 16, '2025-12-22 15:14:47.672169', 'vn', NULL);
INSERT INTO public.viewed_news (id, user_id, news_id, viewed_at, site, news_international_id) VALUES (17, 1, NULL, '2025-12-22 15:24:03.416388', 'en', 13);
...
SELECT pg_catalog.setval('public.news_international_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.saved_news_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.viewed_news_id_seq', 17, true);


--
-- TOC entry 4940 (class 2606 OID 17075)
...
--
-- TOC entry 4942 (class 2606 OID 17073)
...
--
-- TOC entry 4944 (class 2606 OID 17077)
...
--
-- TOC entry 4883 (class 2606 OID 16797)
...
--
-- TOC entry 4885 (class 2606 OID 16795)
...
--
-- TOC entry 4924 (class 2606 OID 16973)
...
--
-- TOC entry 4932 (class 2606 OID 17016)
...
--
-- TOC entry 4934 (class 2606 OID 17018)
...
--
-- TOC entry 4936 (class 2606 OID 17041)
...
--
-- TOC entry 4938 (class 2606 OID 17043)
...
--
-- TOC entry 4900 (class 2606 OID 16836)
...
--
-- TOC entry 4902 (class 2606 OID 16838)
...
--
-- TOC entry 4910 (class 2606 OID 16874)
...
--
-- TOC entry 4912 (class 2606 OID 16872)
...
--
-- TOC entry 4949 (class 2606 OID 17107)
...
--
-- TOC entry 4951 (class 2606 OID 17105)
...
--
-- TOC entry 4953 (class 2606 OID 17109)
...
--
-- TOC entry 4958 (class 2606 OID 17126)
...
--
-- TOC entry 4960 (class 2606 OID 17128)
...
--
-- TOC entry 4917 (class 2606 OID 16937)
...
--
-- TOC entry 4964 (class 2606 OID 17147)
...
--
-- TOC entry 4966 (class 2606 OID 17145)
...
--
-- TOC entry 4904 (class 2606 OID 16863)
...
--
-- TOC entry 4906 (class 2606 OID 16861)
...
--
-- TOC entry 4908 (class 2606 OID 16865)
...
--
-- TOC entry 4889 (class 2606 OID 16821)
...
--
-- TOC entry 4891 (class 2606 OID 16817)
...
--
-- TOC entry 4893 (class 2606 OID 16819)
...
--
-- TOC entry 4925 (class 1259 OID 16994)
...
--
-- TOC entry 4926 (class 1259 OID 17171)
-- Name: idx_comments_news_international_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_comments_news_international_id ON public.comments USING btree (news_international_id);


--
-- TOC entry 4927 (class 1259 OID 16995)
...
--
-- TOC entry 4928 (class 1259 OID 16993)
...
--
-- TOC entry 4894 (class 1259 OID 16886)
...
--
-- TOC entry 4895 (class 1259 OID 16887)
...
--
-- TOC entry 4896 (class 1259 OID 16889)
...
--
-- TOC entry 4897 (class 1259 OID 16888)
...
--
-- TOC entry 4898 (class 1259 OID 16885)
...
--
-- TOC entry 4945 (class 1259 OID 17115)
...
--
-- TOC entry 4946 (class 1259 OID 17116)
...
--
-- TOC entry 4947 (class 1259 OID 17117)
...
--
-- TOC entry 4954 (class 1259 OID 17136)
...
--
-- TOC entry 4955 (class 1259 OID 17134)
...
--
-- TOC entry 4956 (class 1259 OID 17135)
...
--
-- TOC entry 4913 (class 1259 OID 16990)
...
--
-- TOC entry 4914 (class 1259 OID 17178)
-- Name: idx_saved_news_news_international_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_saved_news_news_international_id ON public.saved_news USING btree (news_international_id);


--
-- TOC entry 4915 (class 1259 OID 16989)
...
--
-- TOC entry 4961 (class 1259 OID 17149)
...
--
-- TOC entry 4962 (class 1259 OID 17148)
...
--
-- TOC entry 4918 (class 1259 OID 16992)
...
--
-- TOC entry 4919 (class 1259 OID 17164)
-- Name: idx_viewed_news_news_international_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_viewed_news_news_international_id ON public.viewed_news USING btree (news_international_id);


--
-- TOC entry 4920 (class 1259 OID 16991)
...
--
-- TOC entry 4988 (class 2606 OID 17078)
...
--
-- TOC entry 4967 (class 2606 OID 16800)
...
--
-- TOC entry 4979 (class 2606 OID 16979)
...
--
-- TOC entry 4980 (class 2606 OID 16984)
...
--
-- TOC entry 4981 (class 2606 OID 16974)
...
--
-- TOC entry 4982 (class 2606 OID 17166)
-- Name: comments fk_comments_news_international; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comments
    ADD CONSTRAINT fk_comments_news_international FOREIGN KEY (news_international_id) REFERENCES public.news_international(id) ON DELETE CASCADE;


--
-- TOC entry 4973 (class 2606 OID 17173)
-- Name: saved_news fk_saved_news_news_international; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.saved_news
    ADD CONSTRAINT fk_saved_news_news_international FOREIGN KEY (news_international_id) REFERENCES public.news_international(id) ON DELETE CASCADE;


--
-- TOC entry 4976 (class 2606 OID 17159)
-- Name: viewed_news fk_viewed_news_news_international; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.viewed_news
    ADD CONSTRAINT fk_viewed_news_news_international FOREIGN KEY (news_international_id) REFERENCES public.news_international(id) ON DELETE CASCADE;


--
-- TOC entry 4984 (class 2606 OID 17019)
...
--
-- TOC entry 4983 (class 2606 OID 17005)
...
--
-- TOC entry 4968 (class 2606 OID 16849)
...
--
-- TOC entry 4970 (class 2606 OID 16844)
...
--
-- TOC entry 4985 (class 2606 OID 17054)
...
--
-- TOC entry 4986 (class 2606 OID 17044)
...
--
-- TOC entry 4987 (class 2606 OID 17049)
...
--
-- TOC entry 4971 (class 2606 OID 16875)
...
--
-- TOC entry 4972 (class 2606 OID 16880)
...
--
-- TOC entry 4989 (class 2606 OID 17110)
...
--
-- TOC entry 4990 (class 2606 OID 17129)
...
--
-- TOC entry 4974 (class 2606 OID 16943)
...
--
-- TOC entry 4975 (class 2606 OID 16938)
...
--
-- TOC entry 4977 (class 2606 OID 16960)
...
--
-- TOC entry 4978 (class 2606 OID 16955)
...
-- Completed on 2025-12-22 22:32:16

--
-- PostgreSQL database dump complete
--

\unrestrict J8DvcEKioqTRc0GhPHytVU11xLXG0DppQnsN3A3jrb2ehlvHhtNGf3r2dADzTHk
