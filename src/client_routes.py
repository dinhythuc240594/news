...
# Tạo Blueprint cho client với url_prefix rỗng để điều hướng route
# và template_folder cho các file html trong folder client
client_bp = Blueprint('client', __name__, 
                     url_prefix='',
                     template_folder='templates')

# Khởi tạo client controller và client controller common
